...
for (let x=0; x<data.length;x++) {
    if(!neww.includes(data[x].category)){
        drop.innerHTML+=` <option value="${data[x].category}" >${data[x].category}</option>`
        neww.push(data[x].category)
    }
    // console.log(neww);
...
<div class="abc">
            ...
            <p><b>Rating : </b>${data[i].rating.rate}</p>
